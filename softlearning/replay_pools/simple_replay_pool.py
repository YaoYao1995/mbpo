...
class WeightedReplayPool(FlexibleReplayPool):
    def __init__(self, observation_space, action_space, *args, **kwargs):
        self._observation_space = observation_space
        self._action_space = action_space
        ...
        super(WeightedReplayPool, self).__init__(
            *args, fields_attrs=fields, **kwargs)

    def add_samples(self, samples):
        if not isinstance(self._observation_space, Dict):
            return super(WeightedReplayPool, self).add_samples(samples)
    ...
    def batch_by_indices(self,
                         ...
                         observation_keys=None):
        if not isinstance(self._observation_space, Dict):
            return super(WeightedReplayPool, self).batch_by_indices(
                indices, field_name_filter=field_name_filter)
